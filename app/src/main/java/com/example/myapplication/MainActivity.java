...
public class MainActivity extends AppCompatActivity {
        ...
        private Button searchByPara;

        private Button searchBySurahs;
        @Override
        protected void onCreate(Bundle savedInstanceState) {
                ...
                for (int i = 0; i < englishSurahNames.length; i++) {
                        SurahList.add(englishSurahNames[i]);
                }

                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>
                        (this, android.R.layout.simple_list_item_1, SurahList);
                listView = findViewById(R.id.surahListView);
                listView.setAdapter(arrayAdapter);


                editText = findViewById(R.id.searchView);
                searchByPara = findViewById(R.id.searchByParaBtn);
                searchBySurahs = findViewById(R.id.searchBySurahBtn);
                searchByPara.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            ...
                            for (int i = 0; i < englishParahName.length; i++) {
                                        if (englishParahName[i].equalsIgnoreCase(searchText)) {
                                                index = i;
                                                break;
                                        }
                                }
                                ...
                                if (index != -1) {
                                        int psp1 = PSP[index];
                                        int psp2 = PSP[index + 1];
                                        searchText =  "پارہ کا نام " + ParahName[index];
                ...
                searchBySurahs.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                                String searchText = editText.getText().toString().trim() + " ";
